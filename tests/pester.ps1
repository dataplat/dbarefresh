...
Remove-Module PSDatabaseRefresh -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSDatabaseRefresh.psd1"
Import-Module "$PSScriptRoot\..\PSDatabaseRefresh.psm1" -Force
